...
const formatDetails = [
  {
    ...
    formats: [
      {
        ext: "EPUB",
        description: "Standard ebook format. Full reading support with native rendering, highlights, and bookmarks.",
        conversion: "Target format for MOBI/AZW3/PDF conversion",
      },
      {
        ext: "PDF",
        description: "Portable Document Format. Rendered as page images with zoom. Can be converted to EPUB.",
        conversion: "Can convert to EPUB",
      },
      {
        ext: "MOBI",
        description: "Amazon Kindle format. Auto-converted to EPUB on first access for full reader support.",
        conversion: "Auto-converts to EPUB",
      },
      {
        ext: "AZW3",
        description: "Amazon KF8 format. Auto-converted to EPUB on first access for full reader support.",
        conversion: "Auto-converts to EPUB",
      },
    ],
  },
  {
    ...
    formats: [
      {
        ext: "CBZ",
        description: "Comic Book ZIP archive. Pages extracted and served as images with page navigation.",
        conversion: "Native format",
      },
      {
        ext: "CBR",
        description: "Comic Book RAR archive. Auto-converted to CBZ on first access for extraction.",
  ...
  },
  {
    ...
    formats: [
      {
        ext: "M4B",
        description: "Apple audiobook format with chapter metadata. Supports playback, transcription, and text-to-speech sync.",
        conversion: null,
      },
      {
        ext: "M4A",
        description: "AAC audio format. Can be merged with other audio files into a single audiobook.",
        conversion: null,
      },
      {
        ext: "MP3",
        description: "MP3 audio format. Can be merged with other audio files into a single audiobook.",
        conversion: null,
      },
    ],
  },
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-foreground-muted">
          Compendus supports a wide range of book, comic, and audiobook formats
          with automatic conversion where needed.
        </p>
      </div>
      ...
      <section>
        ...
        <p className="text-sm text-foreground-muted mt-3">
          Covers are automatically extracted from EPUB and PDF files during
          upload. A dominant color is extracted from each cover for UI theming.
        </p>
      </section>
