...
const quickLinks = [
  {
    ...
    description: "Install and run Compendus locally",
  },
...
export default function Home() {
  return (
    <div className="space-y-12">
      {/* Hero */}
      <div>
        <h1 className="text-4xl font-bold text-foreground mb-4">Compendus Documentation</h1>
        <p className="text-lg text-foreground-muted max-w-2xl">
          Compendus is a self-hosted personal digital library manager. Upload, organize, and read
          books across web and iOS with automatic metadata, full-text search, and reading progress
          tracking.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => (
            <div key={feature.title} className="p-5 border border-border rounded-xl">
